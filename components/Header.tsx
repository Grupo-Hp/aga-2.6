...
export const Header = ({ text, subText }: Props): ReactElement => {
    return (
        <div className="bg-header bg-right bg-cover h-[85vh] sm:pl-20 flex items-center">
            <div className="text-center sm:text-left">
                <h1 className="mx-10 sm:mx-0 sm:w-3/4 leading-normal text-3xl sm:text-5xl text-white uppercase">{text}</h1>
